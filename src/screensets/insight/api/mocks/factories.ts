...
const IC_BULLET_DEFS: IcBulletDef[] = [
  ...
  { metric_key: 'pr_cycle_time_h', section: 'git_output', label: 'Pull Request Cycle Time', sublabel: 'Bitbucket \u00b7 PR opened \u2192 merged \u00b7 per-PR median \u00b7 lower = better', unit: 'h', range_min: '4h', range_max: '72h', median: 22, median_label: 'Target <24h', bar_width_pct: 41, median_left_pct: 26, status: 'good', drill_id: 'pull-requests', defaultValue: 18 },
  ...
  { metric_key: 'merge_rate', section: 'git_output', label: 'PR Merge Rate', sublabel: 'Bitbucket \u00b7 \u03a3 merged \u00f7 \u03a3 created over period \u00b7 higher = better', unit: '%', range_min: '30%', range_max: '100%', median: 78, median_label: 'Median: 78%', bar_width_pct: 84, median_left_pct: 69, status: 'good', drill_id: '', defaultValue: 82 },
  { metric_key: 'lines_per_commit', section: 'git_output', label: 'Lines / Commit', sublabel: 'Bitbucket \u00b7 \u03a3 LOC \u00f7 \u03a3 commits \u00b7 lower = reviewable', unit: 'count', range_min: '20', range_max: '500', median: 85, median_label: 'Target <100', bar_width_pct: 70, median_left_pct: 17, status: 'warn', drill_id: '', defaultValue: 353 },
  ...
  { metric_key: 'build_success', section: 'code_quality', label: 'Build Success Rate', sublabel: 'CI \u00b7 passed \u00f7 total runs \u00b7 target \u226590%', unit: '%', range_min: '0%', range_max: '100%', median: 87, median_label: 'Target \u226590% \u00b7 Median: 87%', bar_width_pct: 96, median_left_pct: 87, status: 'good', drill_id: 'builds', defaultValue: 96 },
  { metric_key: 'pr_cycle_time', section: 'code_quality', label: 'Pull Request Cycle Time', sublabel: 'Bitbucket \u00b7 PR opened \u2192 merged \u00b7 lower = better', unit: 'h', range_min: '0h', range_max: '72h', median: 22, median_label: 'Median: 22h', bar_width_pct: 25, median_left_pct: 31, status: 'good', drill_id: 'pull-requests', defaultValue: 18 },
  ...
  { metric_key: 'bugs_fixed', section: 'code_quality', label: 'Bugs Fixed', sublabel: 'Jira \u00b7 bug-type issues closed', unit: 'count', range_min: '0', range_max: '30', median: 9, median_label: 'Median: 9', bar_width_pct: 10, median_left_pct: 30, status: 'good', drill_id: 'bugs-fixed', defaultValue: 3 },
  ...
  { metric_key: 'cursor_lines', section: 'ai_tools', label: 'Lines Accepted', sublabel: 'Cursor \u00b7 lines of code accepted', unit: 'count', range_min: '0', range_max: '5k', median: 1800, median_label: 'Median: 1.8k', bar_width_pct: 48, median_left_pct: 36, status: 'good', drill_id: '', defaultValue: 2400 },
  ...
  { metric_key: 'cc_lines', section: 'ai_tools', label: 'Lines Added (Claude Code)', sublabel: 'Anthropic Enterprise API \u00b7 lines added by Claude Code', unit: 'count', range_min: '0', range_max: '3k', median: 600, median_label: 'Median: 600', bar_width_pct: 28, median_left_pct: 20, status: 'good', drill_id: '', defaultValue: 840 },
  ...
  { metric_key: 'meeting_hours', section: 'collab', label: 'Meeting Hours', sublabel: 'Teams + Zoom \u00b7 longest modality per meeting \u00b7 avg per person \u00b7 period total', unit: 'h', range_min: '0', range_max: '60', median: 20, median_label: 'Median: 20h', bar_width_pct: 36, median_left_pct: 33, status: 'good', drill_id: '', defaultValue: 26 },
  { metric_key: 'meetings_count', section: 'collab', label: 'Meetings Attended', sublabel: 'Teams + Zoom \u00b7 distinct meetings joined \u00b7 avg per person \u00b7 period total', unit: 'meetings', range_min: '0', range_max: '120', median: 37, median_label: 'Median: 37', bar_width_pct: 30, median_left_pct: 31, status: 'good', drill_id: '', defaultValue: 43 },
...
export function mockIcScenario(personId = 'p1'): {
  ...
  const kpiAggregate = mockIcAggregateRow({
    ...
    bugs_fixed: Math.max(0, Math.round(vary(3, personSeed, 2))),
    build_success_pct: Math.min(100, Math.max(70, Math.round(vary(96, personSeed, 6)))),
