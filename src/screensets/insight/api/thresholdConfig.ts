...
export const BULLET_DEFS: BulletThresholdDef[] = [
  ...
  { metric_key: 'estimation_accuracy', section: 'task_delivery', label: 'Estimation Accuracy',               sublabel: 'Jira \u00b7 original estimate \u00f7 time spent \u00b7 capped at 200%',  unit: '%',     drill_id: '',               higher_is_better: true,  range_min: 0,  range_max: 200, median: 58,  good_threshold: 80,  warn_threshold: 50  },
...
export const IC_KPI_DEFS: IcKpiDef[] = [
  ...
  { metric_key: 'clean_loc',       raw_field: 'loc',              label: 'LOC (AI-accepted)', unit: '',  sublabel: 'Cursor',             description: 'Lines accepted from AI suggestions (Cursor). Until a git silver layer lands, this is the only LOC signal — not hand-authored code.',          higher_is_better: true,  format: 'integer'  },
